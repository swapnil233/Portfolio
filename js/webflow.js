...
! function (t) {
    ...
    window.tram = function (t) {
        ...
        var I = e.frame = function () {
            ...
            W = l(function (e) {
                function n() {
                    ...
                    if (r)
                        for (I(n), e = P(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
        ...
        z.transform && (Y.transform = [F], K = {
            ...
            skewX: [k],
            skewY: [k]
        }), z.transform && z.backface && (K.z = [x, "translateZ"], K.rotateZ = [k], K.scaleZ = [w], K.perspective = [y]);
        var Q = /ms/,
            J = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    i.define("navbar", t.exports = function (t, e) {
        ...
        function A(n, i) {
            ...
            c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), C(a), s ? (S(a), a.el.on("setting" + m, function (t) {
                return function (n, i) {
                    i = i || {};
                    var r = f.width();
                    C(t), !0 === i.open && q(t, !0), !1 === i.open && F(t, !0), t.open && e.defer(function () {
                        r !== f.width() && z(t)
                    })
                }
            }(a))) : (! function (e) {
            ...
            }(a), a.button.on("click" + m, D(a)), a.menu.on("click" + m, "a", M(a)), a.button.on("keydown" + m, function (t) {
                return function (e) {
                    switch (e.keyCode) {
                        case o.SPACE:
                        case o.ENTER:
